<div id="header">
    ...
    <form role="search" method="get" id="searchform" action="{{ route('products.search') }}">
        <input type="text" value="" name="query" id="query" placeholder="Nhập từ khóa..." />
    ...
    <div class="container">
        ...
        <nav class="main-menu">
            <ul class="l-inline ov">
                <li><a href="{{ route('banhang.index-show') }}">Trang chủ</a></li>
                <li><a href="#">Sản phẩm</a>
                    <ul class="sub-menu">
                        <li><a href="{{ route('banhang.indexvtmb') }}">Vitamin B</a></li>
                        <li><a href="{{ route('banhang.indexvtmc') }}">Vitamin C</a></li>
                    </ul>
                </li>
                <li><a href="about.html">Giới thiệu</a></li>
                <li><a href="contact">Liên hệ</a></li>
                <li><a href="{{ route('banhang.favorite.list') }}">Yêu thích</a></li>
                <li><a href="bills">Xem lại đơn đặt hàng</a></li> <!-- Thêm mục này -->
            </ul>
            <div class="clearfix"></div>
        </nav>
    </div> <!-- .container -->
